...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $val_check_arr[] = strval($department);
    $val_check_arr[] = strval($school_year);
    $val_check_arr[] = strval($number);
    $val_check_arr[] = strval($status);
...
<head>
    ...
    <title>プロフィールを編集 /「Real intentioN」</title>
    <style>
        body {
            ...
            <div class="row py-5">
                <div class="col-lg-5 col-md-11 col-11 mx-auto">
                    <?php if (count($err_array) > 0) : ?>
                        ...
                        <div class="mt-2">
                            <a class="btn btn-primary px-4" href="./update_form.php">戻る</a>
                        </div>
                    <?php endif; ?>
