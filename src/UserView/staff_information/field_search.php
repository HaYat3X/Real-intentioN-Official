...
// 企業名検索のSQL
$sql = "SELECT * FROM `staff_information_table` INNER JOIN `staff_master` ON staff_information_table.staff_id = staff_master.staff_id WHERE staff_information_table.field LIKE ? ORDER BY staff_information_table.post_id DESC";
