...
// コメント元取得
$post_date = $obj::post_one_acquisition($sql, $arr);
...
// 投稿に紐付いたコメントを取得
$comment_date = $obj::post_one_acquisition($sql2, $arr);
                ...
                <div class="mb-5 bg-light">
                    ...
                    <div class="area1 d-flex px-3 py-4">
                        ...
                        <div class="info-center col-9">
                            <?php h($posts['company']) ?><span
                                style="margin: 0 10px;">/</span><?php h($posts['field']) ?><span
                                style="margin: 0 10px;">/</span><?php h($posts['format']) ?>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="btn-group dropstart" role="group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark">
                                        ...
                                        <li><a href="./delete/delete_check.php?post_id=<?php h($row['id']) ?>"
                                                class="dropdown-item">削除</a></li>
                                        <li><a class="dropdown-item"
                                                href="./update/update_form.php?post_id=<?php h($row['id']) ?>">編集</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="area2 d-flex px-3 py-4">
                        <div class="question-btn col-7">
                            <a href="./comment.php?post_id=<?php h($posts['id']) ?>"
                                class="btn btn-primary">投稿者に質問する</a>
                        </div>
