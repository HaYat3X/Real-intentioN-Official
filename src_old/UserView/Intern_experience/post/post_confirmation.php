                    ...
                    <div class="mx-auto col-lg-8">
                        ...
                        <?php if (count($err_array) === 0) : ?>
                            <form class="mt-5" action="./post.php" method="post">
                                ...
                                <div class="mb-4">
                                    <label for="exampleFormControlTextarea1" class="form-label">回答内容</label>
                                    <textarea class="form-control" name="answer" id="exampleFormControlTextarea1" rows="6" readonly><?php h($_POST['answer']) ?></textarea>
                                </div>
